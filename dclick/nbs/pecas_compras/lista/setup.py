...
class AbaLista:
    ...
    def clicar_botao_incluir_nf_terceiros_via_imagem (self) -> OpcoesInclusaoNfTerceiros:
        ...
        coordenada = self.IMAGEM_INCLUIR_NF_TERCEIROS.procurar_imagem(
